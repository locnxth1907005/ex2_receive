...
namespace URLRecive
{
    class Program
    {
        ...
        private static void StartInfor()
        {
            ...
            {
                channel.QueueDeclare(queue: "amqwebcrawler",
                                     durable: true,
                                     exclusive: false,
                                     autoDelete: false,
                                     arguments: null);
                ...
                consumer.Received += async (model, ea) =>
                {
                    ...
                    if (!myDbContext.Article.Any(o => o.Title == article.Title))
                    {
                        myDbContext.Article.Add(article);
                        myDbContext.SaveChanges();
                    }

                };
                channel.BasicConsume(queue: "amqwebcrawler",
                                             autoAck: true,
                                             consumer: consumer);
